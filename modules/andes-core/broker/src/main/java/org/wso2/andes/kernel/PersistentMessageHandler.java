 ...
 */
public class PersistentMessageHandler {


    private static Log log = LogFactory.getLog(PersistentMessageHandler.class);
    ...
    public PersistentMessageHandler(String queueName) {
