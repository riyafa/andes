 ...
 */
final class NonPersistentMessageDeliveryTask extends Task {

    private static Log log = LogFactory.getLog(NonPersistentMessageDeliveryTask.class);
    ...
    NonPersistentMessageDeliveryTask(StorageQueue storageQueue, MessageFlusher messageFlusher) {
     ...
     * @return name of storage queue handle by this {@link NonPersistentMessageDeliveryTask}
     */
    @Override
    public String getId() {
